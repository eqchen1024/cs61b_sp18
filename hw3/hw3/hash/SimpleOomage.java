...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if (red == o1.red && green == o1.green && blue == o1.blue) {
            return true;
        }
        else {
            return false;
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return  (int) ( red/5 * Math.pow(Math.ceil(256/5),2) +
                    green/5 * Math.pow(Math.ceil(256/5),1) +
                    blue/5 * Math.pow(Math.ceil(256/5),0));
        }
    }
